...
"""
The arg spec for the bgp_large_community module
"""


class Bgp_large_communityArgs(object):  # pylint: disable=R0903
    """The arg spec for the bgp_large_community module
    """
    ...
    argument_spec = {'config': {'options': {'large-community-list': {'elements': 'dict',
