...
"""
The access_list_ipv4 fact class
...
RESOURCE_NAME = 'access_list_ipv4'

class Access_list_ipv4Facts(object):
    """ The access_list_ipv4 fact class
    """

    def __init__(self, module, subspec='config', options='options'):
        return init_facts_internal(self, RESOURCE_NAME, module, subspec, options,
                                   Access_list_ipv4Args.argument_spec)

    def populate_facts(self, connection, ansible_facts, data=None):
        """ Populate the facts for access_list_ipv4
